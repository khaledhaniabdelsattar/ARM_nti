...
*/
void	STK_voidSetIntervalPeriodic(u32	Copy_u32Time,STK_time_t copy_unit, void (*Pf)(void));

/*
  * STK_voidSetIntervalSingle - > pass a one shot function to the SysTick ISR
  * i/p : (u32) Time / (STK_time_t) unit : TIME_MS - TIME_US / void function
*/
void	STK_voidSetIntervalSingle(u32	Copy_u32Time,STK_time_t copy_unit, void (*Pf)(void));
/*
